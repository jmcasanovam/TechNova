      ...
      final screenWidth = MediaQuery.of(context).size.width;
                ...
                if (nombre!.isEmpty || nickname!.isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Nombre y Nickname son obligatorios', style: TextStyle(color: Colors.black, fontSize: screenHeight*0.02),)),
                  );
                  return;
                }
                if (tipoSeleccionado == 'Alumno') {
                  if (contrasenaSeleccionada1 == null || contrasenaSeleccionada2 == null || contrasenaSeleccionada3 == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Selecciona todas las opciones para la contraseña', style: TextStyle(color: Colors.black, fontSize: screenHeight*0.02),)),
                    );
                    return;
                  }
                } else {
                  ...
                  if (contrasena!.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('La contraseña personalizada es obligatoria', style: TextStyle(color: Colors.black, fontSize: screenHeight*0.02),)),
                    );
                    return;
                  }
                }
